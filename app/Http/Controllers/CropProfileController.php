...
class CropProfileController extends Controller
{
    public function cropMyProfile(Request $request)
    {
        ...
        if($result) {
            ...
            $profileUpdated = new Profile();
            $profileUpdated = $profileUpdated->find(Auth::user()->id);
            $profileUpdated->fill( ['avatar'=>$result] )->save();
