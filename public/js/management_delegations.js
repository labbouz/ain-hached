        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.status == 'success') {
                    ...
                    _selectorContainer.find( '.label_elemen' ).find( 'span' ).text(data_elemen.nom_delegation);
                    _selectorContainer.find( 'form' ).find( '#nom_delegation' ).attr('data-reset', data_elemen.nom_delegation);
            ...
            _selectorContainer.find( '.form-box' ).hide('fade', {}, 'fast', function(){
                _selectorContainer.find( '.loader' ).show('fade', {}, 'fast', function(){
                    ...
                    var _dataRequestAction = {
                        _token : _csrf_token,
                        nom_delegation : form.find('#nom_delegation').val(),
