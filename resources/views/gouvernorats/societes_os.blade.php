                    ...
                    <div class="container_element container_display_user">
                        ...
                        <div class="edit_card card box">
                            <div class="label_elemen">
                                <a href="{{ route('societes_regional.observateur_secteur', ['id_gouvernorat' => $gouvernorat->id] ) }}" class="display_objet" dir="rtl">{{ $gouvernorat->nom_gouvernorat }}</a>
                            </div>
                            <div class="toolbar_box"  dir="rtl">

                                <a href="{{ route('societes_regional.observateur_secteur', ['id_gouvernorat' => $gouvernorat->id] ) }}">@lang('societe.nb_societes')  : {{ $gouvernorat->nb_societes }} <i class="fa fa-building-o" aria-hidden="true" ></i></a>
                            </div>
                        </div>
