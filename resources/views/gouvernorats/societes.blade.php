                    ...
                    <div class="container_element container_display_user">
                        ...
                        <div class="edit_card card box">
                            ...
                            <div class="toolbar_box"  dir="rtl">
                                ...
                                <a href="{{ route('societes_region.admin', ['id_secteur' => $secteur->id, 'id_gouvernorat' => $gouvernorat->id] ) }}">{{ $gouvernorat->nb_societes }} <i class="fa fa-building" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="@lang('societe.nb_societes')  : {{ $gouvernorat->nb_societes }}" ></i></a>
                            </div>
                        </div>
