...
@section('header')
    <link href="{{ asset('css/pages/plaintes.css') }}" rel="stylesheet">
@endsection
            ...
            <div class="col-lg-12 col-md-12 col-sm12 col-xs-12">
                <div class="page-title">
                    ...
                    <div id="header_index" class="header_action">
                        ...
                        <h3> @lang('plainte.plaintes')  </h3>
                        <p class="text-muted">@lang('plainte.description_plaintes')</p>
                    </div>
...
@section('url_ajax')
    <input id="index" type="hidden" value="{{ route('json.plaintes.index') }}">
    <input id="store" type="hidden" value="{{ route('plaintes.store') }}">
            ...
            <div class="container_element">
                ...
                <div class="edit_card card box">
                    <div class="label_elemen">
                        <span class="edit" dir="rtl">{nom_plainte}</span>
                    </div>
                    ...
                    <div class="toolbar_box"  dir="rtl">
                        ...
                        <a href="javascript:void(0)" class="remove"
                           ...
                           data-text-warning="@lang('plainte.suppression_defenitife')"
                ...
                <div class="form-box box">
                    <form autocomplete="off" class="form-cart" dir="rtl" data-error="@lang('main.info_monquant')" data-id="{id}">
                        <div class="form-group">
                            <input type="text" class="form-control" id="nom_plainte" placeholder="@lang('plainte.nom_plainte')" value="{nom_plainte}" data-error="@lang('main.info_monquant')" data-reset="{nom_plainte}" required />
                        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 container-action">
            <div class="container_element">
                <a href="javascript:void(0)" class="box add">
                    ...
                    <span class="text">@lang('plainte.add_plainte')</span>
                </a>

                <div class="form-box box">
                    <form autocomplete="off" class="form-cart" dir="rtl" data-error="@lang('main.info_monquant')">
                        <div class="form-group">
                            <input type="text" class="form-control" id="nom_plainte" placeholder="@lang('plainte.nom_plainte')" value="" data-error="@lang('main.info_monquant')" required />
                        </div>
...
@section('footer')
    <script src="{{ asset('js/management_plaintes.js') }}"></script>
@endsection