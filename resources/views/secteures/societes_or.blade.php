            ...
            <div class="col-lg-12 col-md-12 col-sm12 col-xs-12">
                <div class="page-title">
                    <div id="header_index">
                        ...
                        <h3> @lang('societe.classment_societees_selon_secteur') @lang('societe.pour_grouvernorat') {{ $gouvernorat->nom_gouvernorat }}</h3>
                    ...
                    <div class="container_element container_display_user">
                        ...
                        <div class="edit_card card box">
                            ...
                            <div class="toolbar_box"  dir="rtl">
                                <a href="{{ route('societes_secteur.observateur_region', ['id_secteur' => $secteure->id] ) }}"> {{ $secteure->nb_societes }} <i class="fa fa-building" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="@lang('societe.nb_societes')  : {{ $secteure->nb_societes }}"></i></a>
                            </div>
                        </div>
