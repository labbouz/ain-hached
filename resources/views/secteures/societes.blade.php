                    ...
                    <div class="container_element container_display_user">
                        ...
                        <div class="edit_card card box">
                            ...
                            <div class="toolbar_box"  dir="rtl">
                                ...
                                <a href="{{ route('societes_secteur.admin', ['id_secteur' => $secteure->id] ) }}">@lang('societe.nb_societes')  : {{ $secteure->societes->count() }} <i class="fa fa-building-o" aria-hidden="true" ></i></a>
                            </div>
                        </div>
