            ...
            <div class="col-lg-12 col-md-12 col-sm12 col-xs-12">
                <div class="page-title">
                    ...
                    <div id="header_index" class="header_action">
                        ...
                        <h3> @lang('abus.accrochages_plaintes')  </h3>
...
@section('url_ajax')
    <input id="index" type="hidden" value="{{ route('json.accrochages_plaintes.index', $abus->id) }}">
    <input id="store" type="hidden" value="{{ route('accrochages_plaintes.store') }}">
                ...
                <div class="form-box box">
                    <form autocomplete="off" class="form-cart" dir="rtl" data-error="@lang('main.info_monquant')" data-id="{id}">
                        <div class="form-group">
                            <select id="plainte_id" name="plainte_id" class="form-control" data-reset="{plainte_id}">
                                <option value="0">@lang('main.selectionnez')  @lang('abus.accrochages')</option>
                                @foreach ($plaintes as $plainte)
                                    <option value="{{ $plainte->id }}">{{ $plainte->nom_plainte }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="container_element">
                ...
                <div class="form-box box">
                    <form autocomplete="off" class="form-cart" dir="rtl" data-error="@lang('main.info_monquant')">
                        <div class="form-group">
                            <select id="plainte_id" name="plainte_id" class="form-control">
                                <option value="0">@lang('main.selectionnez')  @lang('abus.accrochages')</option>
                                @foreach ($plaintes as $plainte)
                                    <option value="{{ $plainte->id }}">{{ $plainte->nom_plainte }}</option>
                                @endforeach
...
@section('footer')
    <script src="{{ asset('js/management_accrochages_plaintes.js') }}"></script>
@endsection