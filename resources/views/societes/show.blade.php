                        ...
                        <div class="content_accordion collapse" id="collapseAbus{{ $abus->id }}">
                            <div class="row row-rtl">
                                <div class="col-xs-12 col-sm12 col-md-12 col-lg-12">
                                    <div class="box-info box-liste-abus">
                                        <div class="icon_big">
                                            <a href="{{ route('abus.show', ['abus' => $abus]) }}" data-toggle="tooltip" data-placement="top" title="@lang('abus.display_detail_abus')"><i class="fa fa-eye fa-lg"></i></a></div>
                                        <div class="titlr_box">
                                            <h4 dir="rtl">
                                                <?php
                                                ...
                                                ?>
                                                @lang('abus.abu') {{ $abus->violation->gravite->nom_gravite }} {{ $abus->violation->type_violation->nom_type_violation }} @lang('abus.for_date') <strong>{{ $abus->date_violation }}</strong> @lang('abus.resultat_abus_'.$abus->statut_reglement).
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm12 col-md-12 col-lg-12">
                                    <div class="box-info box-liste-abus">
                                        <div class="icon_big">
                                            <a href="{{ route('dossier.show', ['dossier' => $abus->dossier]) }}" data-toggle="tooltip" data-placement="top" title="@lang('dossier.detail_historique_dossier') {{ sprintf("%05d", $abus->dossier->id) }} @lang('abus.abus_from') {{ $abus->dossier->societe->nom_societe }}"><i class="fa fa-folder-open fa-lg"></i></a></div>
                                        <div class="titlr_box">
                                            <h4 dir="rtl">
                                                @lang('abus.from_dossier_numer')  <strong>{{ sprintf("%05d", $abus->dossier_id) }}</strong>.
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-xs-12 col-sm12 col-md-12 col-lg-12">
                                                ...
                                                <h4 dir="rtl">{{ $accrochage->move->nom_move }}
                                                    ...
                                                    @if( $accrochage->date_accrochage != null)
                                                        <?php
                                                        $date_fr = explode('-', $accrochage->date_accrochage );
                                                        $accrochage->date_accrochage = $date_fr[2].'/'.$date_fr[1].'/'.$date_fr[0];
                                                        ?>
